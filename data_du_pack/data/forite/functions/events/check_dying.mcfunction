...
execute as @e[tag=h_marker] run execute at @s run function forite:death_marker/track
...
execute as @e[tag=n_marker] run execute at @s run function forite:death_marker/create
